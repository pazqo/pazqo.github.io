export const workExperience = [
  ...
  {
    title: 'Senior Software Engineer @ Google Switzerland GmbH',
    dateRange: 'Jan 2020 - Jun 2024',
    description: 'Worked as Senior Software Engineer in the Local Shopping Quality',
  },
  {
    title: 'AI Lead @ R&D, UniCredit SpA',
    dateRange: 'Oct 2013 - Nov 2019',
    description: (
      <>
        Career progression: Data Scientist → ML/AI Engineer → AI Lead.<br />
        Worked on a variety of projects, from NLP to Graph analytics
      </>
    ),
  },
  {
